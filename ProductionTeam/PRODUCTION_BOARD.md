...
| motion-comic-eiffel-scam-01 | PC2 / Codex | main | revision-planned | `motion-comic-eiffel-scam-01-v2-revision-brief.md`を同期し、思考過程・感情曲線・逮捕注記を反映したv2を別ファイルで制作 | v1素材＋新聞場面・気づき顔の追加画像が必要 | v1: `out/motion-comic-eiffel-scam-01-final.mp4`（15.8秒、ローカル） | 未定 |
